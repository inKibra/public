      ...
      <button
        onClick={async () => {
          const prepareResponse = await prepare(
            'https://github.com/inKibra/tauri-plugins/releases/download/ota-update/manifest-example.json',
          );
          console.log('prepareResponse', prepareResponse);
        }}
      >
        Prepare (Valid Update)
      </button>
      <button
        onClick={async () => {
          const prepareResponse = await prepare(
            'https://github.com/inKibra/tauri-plugins/releases/download/ota-update/manifest-example-invalid.json',
          );
          console.log('prepareResponse', prepareResponse);
        }}
      >
