...
export async function vibrate(
  pattern: HapticVibrateRequest,
): Promise<HapticResponse> {
...
export async function impactFeedback(
  ...
  return await invoke<HapticResponse>(
    'plugin:haptic-feedback|impact_feedback',
    {
      payload: {
        style,
      },
...
export async function selectionFeedback(): Promise<HapticResponse> {
  return await invoke<HapticResponse>(
    'plugin:haptic-feedback|selection_feedback',
  );
}
